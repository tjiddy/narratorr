...
export interface NotifierFieldProps {
  register: UseFormRegister<CreateNotifierFormData>;
  errors: FieldErrors<CreateNotifierFormData>;
}

export function WebhookFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
...
export function DiscordFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
      <div className="sm:col-span-2">
...
export function ScriptFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
      <div className="sm:col-span-2">
...
export function EmailFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
      <div>
...
export function TelegramFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
      <div className="sm:col-span-2">
...
export function SlackFields({ register, errors }: NotifierFieldProps) {
  return (
    <div className="sm:col-span-2">
...
export function PushoverFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
      <div>
...
export function NtfyFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
      <div>
...
export function GotifyFields({ register, errors }: NotifierFieldProps) {
  return (
    <>
      <div>
