...
describe('AudnexusProvider', () => {
  ...
  describe('getChaptersDetailed — chapter-runtime rescue lookup (#1932)', () => {
    ...
    it('ok + isAccurate:true + positive runtimeLengthMs → usable runtime', async () => {
    ...
    it('ok + isAccurate:null → valid ok, not usable, NOT invalid_record (F14)', async () => {
    ...
    it('ok + isAccurate omitted → valid ok, not usable, NOT invalid_record (F14)', async () => {
