...
import { eq, and, sql, inArray, notExists, desc, type SQL } from 'drizzle-orm';
import type { Db, DbOrTx } from '../../db/index.js';
import type { FastifyBaseLogger } from 'fastify';
import { books, authors, narrators, bookAuthors, bookNarrators, unmatchedGenres, importLists, importJobs } from '../../db/schema.js';
...
export class BookPathOutsideLibraryError extends Error {
  ...
  constructor(
    ...
    super(`Book path "${bookPath}" is not inside library root "${libraryRoot}"`);
