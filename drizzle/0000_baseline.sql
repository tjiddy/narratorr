...
--> statement-breakpoint
CREATE UNIQUE INDEX `companion_ebooks_book_id_unique` ON `companion_ebooks` (`book_id`);--> statement-breakpoint
...
CREATE INDEX `idx_import_submissions_status_updated` ON `import_submissions` (`status`,`updated_at`);--> statement-breakpoint
CREATE INDEX `idx_import_submissions_source_created_id` ON `import_submissions` (`source`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_import_submissions_created_id` ON `import_submissions` (`created_at`,`id`);--> statement-breakpoint
