...
### F1: Unrelated .claude/cl/* artifacts from #355 in PR diff
**What was caught:** The PR diff included `.claude/cl/debt.md`, `.claude/cl/workflow-log.md`, and 4 learning files from issue #355 because local main was ahead of origin/main.
